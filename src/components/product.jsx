...
const [details, setDetails] = useState({});
 ...
 useEffect (()=>{
  ...
  return (
    <div>
        <div className="max-w-screen-xl max-auto my-10 flex gap-10">
            ...
            <p className="text-2xl font-medium text-gray-900">
               ...
               <p className="text-xs text-gray-500 +mt-3">(1 Customer review)</p>
               </div>
               <p className="text-base text-gray-500 ">This product exceeded my expectations. 
               The quality is exceptional, and it has made my life so much easier. I couldn't be happier with my purchase.</p>
            <div className="flex gap-4">
                <div className="w-52 flex items-center justify-between text-gray-500 
                gap-4 border p-3">
